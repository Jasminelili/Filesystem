                ...
                <div class="col-md-6">
                    <div class="panel">
                        ...
                        <div class="panel-body container-fluid">
                            <form:form id="Form" modelAttribute="files" action="/myFiles/uploadFiles" method="post" enctype="multipart/form-data" autocomplete="off">
